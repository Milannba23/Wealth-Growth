function calculateSavings() {
    ...
    // 6. Display the result with the preferred styling
    ...
    // This exact structure uses <b> tags to trigger the green color from your CSS
    document.getElementById('result').innerHTML =
        `Future Wealth: <b>${formattedBalance} ${currency}</b><br>` +
        `Total Invested: ${formattedInvested} ${currency}<br>` +
        `Total Profit: <b>${formattedProfit} ${currency}</b>`;
}
